...
func (ec *executionContext) _Query_hello(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOHello2ᚖgithubᚗcomᚋsebᚑschulzᚋhelloᚑworldᚋgraphᚋmodelᚐHello(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOHello2ᚖgithubᚗcomᚋsebᚑschulzᚋhelloᚑworldᚋgraphᚋmodelᚐHello(ctx context.Context, sel ast.SelectionSet, v *model.Hello) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
